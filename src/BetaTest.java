...
public class BetaTest {
    ...
    public static void main(String[] args) {
    	...
    	String datei = "RandomData\\50nodes\\50nodes2colors";
        ...
        BetaSkeletonizer bSkel = new BetaSkeletonizer(new HashSet<Vector2D>(pointList), beta);       
        bSkel.skeletonize();
        
        
        
        for(Vector2D v : bSkel.V)
        {
        ...
        GreedyClusterMin gcm = new GreedyClusterMin(bSkel.V, bSkel.E, colors);
        gcm.runGreedy();
...
//        content += "Runtime Greedy: " + gcm.time + " ms\n";
        ...
        Writer out;
		try {
			out = new FileWriter(datei+"Beta"+beta+"Solved.svg");
