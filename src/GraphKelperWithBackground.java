...
import backgroundmap.MapFrameWithBackground;
...
public class GraphKelperWithBackground {
	...
	public static void main(String[] args)
	{
		try {
			...
			//displayGraph("SubInstancesPOIS\\Solutions\\Field3count50WithBeta0.5Greedyfilled.graphml");
	...
	{	
		...
		{
			translation.put(ncolors[i], ncolors[i]);
		}
        ...
        viewer.base.ListLayer roadLayer = new viewer.base.ListLayer(new BasicSymbolFactory(Color.GRAY, Color.GRAY));
		...
		myMapFrame.getMap().fitBoxToDisplay(363746,5620840,366470,5623282);
