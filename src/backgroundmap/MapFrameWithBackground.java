...
public class MapFrameWithBackground extends JFrame {
    
    protected MapWithBackground myMap;
    private JLabel xLabel;
    private JLabel yLabel;
    private static final long serialVersionUID = 1L;

    public MapFrameWithBackground(String title, boolean isMainWindow) {
        ...
        myMap = new MapWithBackground(this);
    ...
    public MapWithBackground getMap() {
    	return myMap;
    }
}