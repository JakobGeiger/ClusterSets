...
public class DelaunayTriangulator {
    ...
    public DelaunayTriangulator(Point2D[] pointSet) {
    	this.pointSet = new ArrayList<Vector2D>();
    	for(Point2D p:pointSet) {
    		this.pointSet.add(new Vector2D(p.getX(), p.getY()));
    	}
     ...
     *         no triangle exists
     */
    public Triangle2D findNeighbour(Triangle2D t, Edge2D e)
    {
    	return triangleSoup.findNeighbour(t,e);
    }
